        ...
        <div class="row">
            ...
            <form method="post">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="title" id="" class="form-control" required placeholder="Enter Book Title">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="" class="col-sm-2 col-form-label">Author's Name</label>
                    <div class="col-sm-10">
                        <input type="text" name="author" id="" class="form-control" required placeholder="Enter Author's Name" >
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="" class="col-sm-2 col-form-label">Availability</label>
                    <div class="col-sm-10">
                        <input type="text" name="available" id="" class="form-control" required placeholder="Enter YES or NO">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="" class="col-sm-2 col-form-label">No. of Pages</label>
                    <div class="col-sm-10">
                        <input type="number" name="pages" id="" class="form-control" required placeholder="Enter number of Pages">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="" class="col-sm-2 col-form-label">ISBN No.</label>
                    <div class="col-sm-10">
                        <input type="number" name="isbn" id="" class="form-control" required placeholder="Enter ISBN number" >
                    </div>
                </div>
